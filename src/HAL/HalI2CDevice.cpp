...
void HalI2CDevice::WriteRegBytes(uint8_t reg, const uint8_t* data, int dataSize)
{
...
int HalI2CDevice::ReadRegByte(uint8_t reg, uint8_t* data)
{
...
int HalI2CDevice::ReadRegBytes(uint8_t reg, uint8_t* data, int dataSize)
{
	_I2C->Write(_SlaveAddress, &reg, 1);
